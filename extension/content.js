...
console.log(YoutubeTranscript.YoutubeTranscript.fetchTranscript);
let transcript = "";

// YoutubeTranscript.YoutubeTranscript.fetchTranscript('sJIAzPQRxOU').then((transcriptArray) => {
...
(async function () {
    ...
    //     setTimeout(1500)
    // }
    let transcript = await YoutubeTranscript.YoutubeTranscript.fetchTranscript('sJIAzPQRxOU')
    console.log(transcript);
})();
